...
class RP1Coolant:
    ...
    def base_data(self) -> np.array:
        return np.genfromtxt(r'/BaseEngineCycle/Data/Abdulagatov2011_RP1_Heat_Capacity_Data.csv', delimiter=',')

    @cached_property
    def arlc_data(self) -> np.array:
        return np.genfromtxt(r'/BaseEngineCycle/Data/ALRC(Aerojet)1961_RP1_HeatCapacity_Data.csv', delimiter=',')
