...
class HeatExchanger:
    ...
    max_hot_side_wall_temp: float = field(init=False, repr=False, default=0)
    ...
    def output_message(self):
        ...
        print(f'Max. Hot Side Wall Temp.     : {self.max_hot_side_wall_temp:.2f} K')
        print(f'Coolant Outlet Total Temp.   : {T0_2:.2f} K')
        print(f'Coolant Outlet Total Pressure: {T0_2:.2f} K')
