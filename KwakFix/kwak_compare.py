...
def full_output(kwak_fix, design_args=args.desgin_arguments, common_args=args.common_arguments_kwak, ):
    ...
    if kwak_fix:
        ...
        gg_args = args.gg_arguments_rp1_kwak
    ...
    input_col1 = [
        ...
        ep_cycle.pressurant_initial_state.heat_capacity_ratio,
        ...
        ep_cycle.pressurant_initial_state.specific_gas_constant,
    ...
    input_col2 = [
        ...
        ep_cycle.oxidizer.density,
        ep_cycle.fuel.density,
        gg_args['gg_material'].density,
        arguments['fuel_tank_material'].density,
        arguments['oxidizer_tank_material'].density,
        arguments['pressurant_tank_material'].density,
        gg_args['gg_material'].yield_strength * 1e-6,
        arguments['fuel_tank_material'].yield_strength * 1e-6,
        arguments['oxidizer_tank_material'].yield_strength * 1e-6,
        arguments['pressurant_tank_material'].yield_strength * 1e-6,
    ]
    ...
    gg_results = [
        ...
        gg_cycle.inverse_mass_ratio_kwak,
        0.,
    ...
    ep_results = [
        ...
        ep_cycle.inverse_mass_ratio_kwak,
        0.,
    ...
    empty_col = [None] * 70
    col2 = input_col2
    col3 = [None] * 9 + [vals['characteristic_velocity']] + [None] * 7 + gg_iter_list + [None] * 2 + ep_iter_col1 + [
        None] * 4 + gg_results
    colx = [None] * 9 + [vals['ideal_thrust_coefficient']] + [None] * 39 + ep_results
    col4 = [None] * 9 + [vals['base_mass_flow']] + [None] * 7 + gg_before_iter_list + [None] * 2 + ep_iter_col2 + [
        None] * 4 + ratio_results
    ...
    path = rf'C:\Users\rvand\PycharmProjects\ThesisEP2\data\full_output_kwak_comparison{time}_{suffix}.xlsx'
