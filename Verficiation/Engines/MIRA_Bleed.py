...
from EngineComponents.Base.HeatTransferSection import HeatTransferSection
...
if __name__ == '__main__':
    ...
    for EngineClass, pressurething in zip((MIRA_Exact, MIRA), ('exact', 'estimated')):
        ...
        data = [('Name', '[Unit]', 1, 1),
                ...
                ('Heat Transfer', '[MW]', engine.cooling_channel_section.heat_flow_rate * 1e-6, 6.749),
                ('Heat Transfer2', '[MW]', engine.secondary_cooling_channel_section.heat_flow_rate * 1e-6, .302),
                ...
                # ('', '[]', 1, 1),
                ('Act. Heat Trans.', '[MW]', engine.heat_transfer_section.heat_flow_rate * 1e-6, 6.749),
